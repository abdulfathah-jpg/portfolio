...
![Sample Page from Corpus]({{site.baseurl}}images/testimage.jpg)
...
![Animated Map Full]({{site.baseurl}}images/map_full.png)

![Animated Map Zoomed]({{site.baseurl}}images/map_zoom.png)

[Click here to view the interactive Pilgrimage Map](https://abdulfathah-jpg.github.io/portfolio/project2/visualization/pilgrimage_bus_walk_map.html)
...
![Streamgraph]({{site.baseurl}}images/streamgraph.png)

[Click here to view the interactive Streamgraph](https://abdulfathah-jpg.github.io/portfolio/project2/visualization/streamgraph.html)
...
Altair was used forplotting and Tooltips were enabled for interactive exploration of the data points. The unreadable axis labels were solved through Label rotation + width=2000, and the missing semantic context was dealt with by adding Level-1 translated labels into X-axis
...
All categories (Place names, Ritual concepts, Sacred objects, Revered persons, Everyday objects/persons, Instructive language) were visualized except Arabic litanies, which were excluded from visualization due to their length and extreme sparsity, which are not useful for further analyses

![Dot Raster for Place Name]({{site.baseurl}}images/place_dot.png)

[Clich here for Interactive Dot Raster Graph on Place Names](https://abdulfathah-jpg.github.io/portfolio/project2/visualization/place_names_dot_raster.html)

![Dot Raster for Everyday Objects]({{site.baseurl}}images/everyday_dot.png)

[Clich here for Interactive Dot Raster Graph on Everday Objects](https://abdulfathah-jpg.github.io/portfolio/project2/visualization/everyday_objects_and_persons_dot_raster.html)

![Dot Raster for Instructive Language]({{site.baseurl}}images/instructive_dot.png)

[Clich here for Interactive Dot Raster Graph on Instructive Language](https://abdulfathah-jpg.github.io/portfolio/project2/visualization/instructive_language_dot_raster.html)

![Dot Raster for Revered Persons]({{site.baseurl}}images/revered_dot.png)

[Clich here for Interactive Dot Raster Graph on Revered Persons](https://abdulfathah-jpg.github.io/portfolio/project2/visualization/revered_persons_dot_raster.html)

![Dot Raster for Sacred Objects]({{site.baseurl}}images/sacred_object_dot.png)

[Clich here for Interactive Dot Raster Graph on Sacred Objects](https://abdulfathah-jpg.github.io/portfolio/project2/visualization/sacred_objects_dot_raster.html)

![Dot Raster for Ritual Concepts]({{site.baseurl}}images/ritual_dot.png)

[Clich here for Interactive Dot Raster Graph on Ritual Concepts](https://abdulfathah-jpg.github.io/portfolio/project2/visualization/ritual_concepts_dot_raster.html)
