...
- sacred_objects(Eg. ഹുജ്റ ശരീഫ്, സ്വഫാ, മതാഫ്)
...
6. When any entity (revered persons, place names, sacred objects, everyday objects and persons, ritual concepts, or instructive langauge) appears inside a longer phrase (e.g., because of grammar, inflection, suffix or additional context), list it in the correct noun form so that it becomes easy to count all similar elements of entities. For instance, നിയ്യത്തോടെ should be listed as നിയ്യത്ത്, മസ്ജിദുൽ ഹറാമിനാണ് should be listed as മസ്ജിദുൽ ഹറാം, നിർബന്ധമാണ് should be listed as നിർബന്ധം,  ) 
...
output_file = "ner_by_section_nested_3.json"
